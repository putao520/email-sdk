...
public class Mail {
    ...
    private Mail(String smtpHost, String sendUserName, String sendUserPass, String to, String cc, String mailSubject, String mailBody,
     ...
     * @return
     */
    public static Mail entity(String smtpHost, String sendUserName, String sendUserPass, String to, String cc, String mailSubject, String mailBody,
                              List<String> attachments) {
        return new Mail(smtpHost, sendUserName, sendUserPass, to, cc, mailSubject, mailBody, attachments);
    }
     ...
     * @return
     */
    public static Mail defaultEntity(JSONObject rJSON, String to, String cc, String subject, String body, List<String> attachments) {
    	defaultSmtpHost = rJSON.get("smtp").toString();
    	defaultSenderName = rJSON.get("userid").toString();
    	defaultSenderPass = rJSON.get("password").toString();
        return new Mail(defaultSmtpHost, defaultSenderName, defaultSenderPass, to, cc, subject, body, attachments);
    }
